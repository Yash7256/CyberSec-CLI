...
class CommandParser:
    ...
    def parse(self, text: str) -> Command:
        ...
        if normalized_text in self.COMMAND_ALIASES:
            return Command(action=self.COMMAND_ALIASES[normalized_text], raw_input=text)
        ...
        return Command(action="query", parameters={"query": text}, raw_input=text)
