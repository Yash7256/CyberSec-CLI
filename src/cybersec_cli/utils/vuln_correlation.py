...
# NOTE: cve_correlations are intentionally empty here.
# Real CVE data is fetched live via cve_enrichment.py (NVD API).
# Do NOT add placeholder CVE IDs — they appear verbatim in user reports.
