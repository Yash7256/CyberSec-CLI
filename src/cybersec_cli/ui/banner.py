...
def show_banner():
    ...
    warning = "[bold yellow]WARNING:[/] This tool is for authorized security testing only.\n" \
...
def show_scan_banner(scan_type: str, target: str):
    ...
    console = Console()
    console.print("\n" + "=" * 80)
    console.print(f"[bold cyan]Starting {scan_type.upper()} scan on:[/] [bold white]{target}[/]")
    console.print("=" * 80 + "\n")
