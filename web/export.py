...
def export_scan_json(
    target: str, scan_output: str, enrichment: Optional[Dict] = None
) -> str:
...
def save_report(
    target: str, scan_output: str, enrichment: Optional[Dict] = None, fmt: str = "json"
) -> Optional[str]:
