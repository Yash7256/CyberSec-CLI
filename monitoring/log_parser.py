...
class LogParser:
            ...
            for entry in self.parse_log_file(log_file):
                ...
                if start_time or end_time:
                    try:
                        ...
                        continue
                if message_pattern and not re.search(message_pattern, entry.get('message', ''), re.IGNORECASE):
                    continue
    ...
    def get_recent_logs(self, component: Optional[str] = None, limit: int = 50) -> List[Dict[str, Any]]:
    ...
    def get_error_logs(self, component: Optional[str] = None, hours: int = 24) -> List[Dict[str, Any]]:
