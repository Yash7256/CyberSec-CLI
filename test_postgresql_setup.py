...
def test_schema_file():
    ...
    schema_path = os.path.join(os.path.dirname(__file__), 'database', 'postgres_schema.sql')
...
def test_migration_script():
    ...
    migration_path = os.path.join(os.path.dirname(__file__), 'database', 'migrate_sqlite_to_postgres.py')
