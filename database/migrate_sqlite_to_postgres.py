...
async def migrate_scans(sqlite_scans: List[Dict[str, Any]], postgres_client: PostgresClient, 
...
async def main():
    ...
    parser.add_argument('--sqlite-db', default='./reports/scans.db', 
    ...
    # Perform migration
    try:
        migrated_count = await migrate_scans(sqlite_scans, postgres_client, args.dry_run)
