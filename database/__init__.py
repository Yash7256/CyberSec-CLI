...
class DatabaseInterface:
    ...
    async def create_scan(self, target: str, user_id: Optional[str] = None, 
        ...
        Returns:
            Scan ID
        """
        if self.db_type == DatabaseType.POSTGRESQL and HAS_POSTGRES and self.initialized:
    ...
    async def list_user_scans(self, user_id: str, limit: int = 50, 
